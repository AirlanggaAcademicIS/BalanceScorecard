...
<div class="container-fluid text-center">
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
			...
			<br></br>
                <table id="statustabel" class="table table-bordered table-striped" style="background:#F9F9F9; font-size:18px; font-family:Geneva, Arial, Helvetica, sans-serif;" >
                    <thead>
                        <tr>
						...
						<tr>
							...
							{
							echo "<h1 style=\"font:Arial, Helvetica, sans-serif; font-size:20px;\">"."<a href=\"viewlpj.php\">".$data['NAMA_PROKER']."</a></h1>";
							}
							}
							?>
							</td>
				...
				<input type="submit" name="print" value="Print" style="width:75px; height:35px; border:1px dotted #333333; border-radius:4px; -moz-border-radius:4px; font-family:Garamond; font-size:24px; margin-left:10px; cursor:pointer">
				</form>
