  ...
  <div class="row content">
	...
	<?php 
	   if(isset($_POST['Submit']))
	   {
			...
			{
				$sql = "INSERT INTO LAPORAN_PERTANGGUNG_JAWABAN (EVALUASI, KEBERLANJUTAN, ID_PROKER) VALUES('".$_POST['eval']."','".$_POST['keberlanjutan']."',".$_REQUEST['idproker'].")";			$query = mysqli_query($konek_db,$sql);
	 ...
	 <form name = "form" action="karyawan_inputlpj.php?id=<?php echo $_SESSION['idnya'];?>" method="post" enctype="multipart/form-data">
     ...
     <div class="form-group">
      ...
      <div class="col-sm-10">
		...
		$data = "select distinct i.ID_INDIKATOR_TUJUAN, i.NAMA_INDIKATOR_TUJUAN from INDIKATOR_TUJUAN i, PROKER p, MENUNJANG m where m.ID_INDIKATOR_TUJUAN = i.ID_INDIKATOR_TUJUAN and m.ID_PROKER = p.ID_PROKER and p.ID_PROKER = '".$_SESSION['idnya']."'";
 		 		$query = mysqli_query($konek_db,$data);
