...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
            <h2 class="text-center">Indikator Tujuan</h2>
			<table id="example1" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            <th>Nomor</th>
							<th>ID Indikator Tujuan</th>
                            <th>ID Tujuan</th>
...
$queri="SELECT * FROM INDIKATOR_TUJUAN";
...
while ($data = mysqli_fetch_array ($hasil)){  
 			...
 			echo "      
        			<tr>  
        			<td>".$id."</td>
					<td>".$data['ID_INDIKATOR_TUJUAN']."</td>  
        			<td>".$data['ID_TUJUAN']."</td>  
        			<td>".$data['NAMA_INDIKATOR_TUJUAN']."</td>   
					<td><a href=\"detail.php?id=".$data['ID_INDIKATOR_TUJUAN']."&&tipe=indikator\">"."Detail</a> "." || <a href=\"ubah.php?id=".$data['ID_INDIKATOR_TUJUAN']."&&tipe=indikator\">"."Ubah</a>"." || <a href=\"delete.php?id=".$data['ID_INDIKATOR_TUJUAN']."&&tipe=indikator\">"."Delete</a></td>
        		</tr>   
        	";      
			}
				if($id==0){
