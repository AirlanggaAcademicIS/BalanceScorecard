...
$queri="SELECT * FROM LAPORAN_PERTANGGUNG_JAWABAN";
...
while ($data = mysqli_fetch_array ($hasil)){  
 			...
 			echo "      
					...
					<td><a href=\"detail.php?id=".$data['ID_LPJ']."&&tipe=lpj\">"."Detail</a> "." || <a href=\"ubah.php?id=".$data['ID_LPJ']."&&tipe=lpj\">"."Ubah</a>"." || <a href=\"delete.php?id=".$data['ID_LPJ']."&&tipe=lpj\">"."Delete</a></td>
        		</tr>   
        	";      
			}
				if($id==0){
