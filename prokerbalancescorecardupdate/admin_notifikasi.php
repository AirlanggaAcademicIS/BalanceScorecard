...
while ($data = mysqli_fetch_array ($hasil)){  
 			...
 			echo "      
        			<tr>  
        			<td>".$id."</td>
					<td>".$data['ID_NOTIFIKASI']."</td>  
        			<td>".$data['ID_PROKER']."</td>  
        			<td>".$data['NOTIFIKASI']."</td>   
					<td><a href=\"detail.php?id=".$data['ID_NOTIFIKASI']."&&tipe=notifikasi\">"."Detail</a> "." || <a href=\"ubah.php?id=".$data['ID_NOTIFIKASI']."&&tipe=notifikasi\">"."Ubah</a>"." || <a href=\"delete.php?id=".$data['ID_NOTIFIKASI']."&&tipe=notifikasi&&id2=".$data['ID_PROKER']."\">"."Delete</a></td>
        		</tr>   
        	";      
			}
				if($id==0){
