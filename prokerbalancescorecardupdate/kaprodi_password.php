...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
			...
			<form method="post" action="kaprodi_password.php">
			...
			<input name="password2" type="password" id="password2" size="25" class="form-control" placeholder="Konfirmasi password" required="required" /><br>
