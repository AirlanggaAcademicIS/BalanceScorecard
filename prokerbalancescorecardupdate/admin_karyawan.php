...
while ($data = mysqli_fetch_array ($hasil)){  
 			...
 			echo "      
        			...
        			<td>".$data['NAMA']."</td>  
        			<td>".$data['JABATAN']."</td>   
					<td><a href=\"detail.php?id=".$data['NIP']."&&tipe=karyawan\">"."Detail</a> "." || <a href=\"ubah.php?id=".$data['NIP']."&&tipe=karyawan\">"."Ubah</a>"." || <a href=\"delete.php?id=".$data['NIP']."&&tipe=karyawan\">"."Delete</a></td>
        		</tr>   
        	";      
			}
				if($id==0){
