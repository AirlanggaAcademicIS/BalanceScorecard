...
while ($data = mysqli_fetch_array ($hasil)){  
 			...
 			echo "      
					...
					<td><a href=\"detail.php?id=".$data['ID_PROKER']."&&tipe=proker\">"."Detail</a> "." || <a href=\"ubah.php?id=".$data['ID_PROKER']."&&tipe=proker\">"."Ubah</a>"." || <a href=\"delete.php?id=".$data['ID_PROKER']."&&tipe=proker\">"."Delete</a></td>
        		</tr>   
        	";      
			}
				if($id==0){
